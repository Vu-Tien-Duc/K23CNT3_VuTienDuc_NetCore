...
namespace K23CNT3_VuTienDuc_2310900023.Areas.VtdAdmin.Controllers
{
    ...
    public class VtdCustomersController : VtdBaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("VtdId,VtdFullName,VtdEmail,VtdPhone,VtdAddress,VtdAvatar,VtdBirthday,VtdGender,VtdPassword,VtdFacebook")] VtdCustomer vtdCustomer)
        {
            ...
            {
                // 1. MÃ HÓA MẬT KHẨU KHÁCH HÀNG
                vtdCustomer.VtdPassword = VtdSecurity.ComputeMD5Hash(vtdCustomer.VtdPassword);
