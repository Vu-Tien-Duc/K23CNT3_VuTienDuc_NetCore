...
namespace VtdLab07bt2.Controllers
{
    public class VtdCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VtdId,VtdName,VtdStatus,VtdCreatedDate")] VtdCategory vtdCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VtdId,VtdName,VtdStatus,VtdCreatedDate")] VtdCategory vtdCategory)
        {
